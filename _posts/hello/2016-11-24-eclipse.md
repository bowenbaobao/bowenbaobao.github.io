...
eclipse 导入此模板  Window--Java--Code Style--Code Templates--Comments--Import

光标停在需要加注释的方法或变量上使用 Alt+Shift+j
...
eclipse 导入:  Window--Java--Code Style--Formatted--Import
...
Window--Preferceces--General--Workspace
...
Window-- Preferceces--General -- Content Types

设置css  js  jsp  html  properties  UTF-8
...
Window-- Preferceces--Validation

去掉js  html 等合法性验证，以提高eclipse 编译软件的速度

勾选：

Allow orojects to override these preference settings
...
Window--Preferceces--Maven--User Settings

d:\Program\apache-maven-3.2.1\conf\settings.xml
...
*.class whthout source 

设置  JadClipse Class File Viewer(default)
